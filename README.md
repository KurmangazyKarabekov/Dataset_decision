...
* 4_Alternative_solution.ipynb - показано 2 решение 2-ъ задач: 
    1) Решение задачи классификации. Кодируем target 0 и 1, где 0 -  клиент ничего не потратит, 1 - клиент потратит какую-то сумму
    2) Как только определили людей которуые потратят какую-то сумму денег. Решаем задачу регресси и предсказываем сумму
